...
class Ultrasonic extends EventEmitter {
  ...
  foundPeripheral (peripheral) {
    ...
    debug(JSON.stringify(Object.keys(peripheral)), JSON.stringify(Object.keys(peripheral.advertisement)))
    debug(`Found a peripheral: ${name} (match with ${match}? ${(name == match)})`)
